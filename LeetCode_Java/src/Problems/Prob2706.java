...
public class Prob2706 {
	...
	private static void test() {
		int[] testArr;
		Solution2706 solObj = new Solution2706();
		int money;
		
		testArr = nums1;
		money = 3;
		System.out.println("Arr: " + Arrays.toString(testArr) + " money: " + money);
		System.out.println("Ans: " + solObj.buyChoco(testArr,money));
		/*
